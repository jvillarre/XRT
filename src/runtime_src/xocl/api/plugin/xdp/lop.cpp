  ...
  void warning_function()
  {
    if (xrt_xocl::config::get_opencl_trace())
    {
      xrt_xocl::message::send(xrt_xocl::message::severity_level::warning,
                              "Both low overhead OpenCL profiling and detailed OpenCL trace are enabled.  The trace generated by low overhead profiling will reflect the higher overhead associated with detailed OpenCL.  For best performance of low overhead profiling, please disable detailed OpenCL trace.\n") ;
    }
  }
